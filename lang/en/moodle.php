...
$string['prueba'] = 'Aquí va mi mensaje de prueba';
$string['welcomemessage2'] = '<p style="color:blue">En este mensaje se debe remplazar una variable {$a->coursename}</p>';
$string['welcomemessage'] = '<p style="color:blue">En este mensaje se debe remplazar una variable {$a->coursename}</p>';
