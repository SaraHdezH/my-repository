...
function message_post_message($userfrom, $userto, $message, $format) {
    ...
    if ($format != FORMAT_HTML) {
        ...
        echo("<script>console.log('PHP: ".$eventdata->fullmessagehtml."');</script>");
        ...
        //echo("<script>console.log('PHP: ".$eventdata->fullmessage."');</script>");
    } else {
    ...
    if (!empty($eventdata->fullmessage)) {
        $eventdata->fullmessage .= "\n\n---------------------------------------------------------------------\n".$emailtagline.$format."...".$eventdata->fullmessage."...".$eventdata->fullmessagehtml;
    }
